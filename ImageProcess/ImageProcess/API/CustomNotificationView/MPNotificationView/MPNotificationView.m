...
- (void) handleTap:(UITapGestureRecognizer *)gestureRecognizer
{
    ...
    if ([self.delegate respondsToSelector:@selector(tapReceivedForNotificationView:)])
    {
        [self.delegate  didTapOnNotificationView:self];
    }
    
    if ([self.delegate respondsToSelector:@selector(didTapOnNotificationView:)])
    {
        [self.delegate  didTapOnNotificationView:nil];
    }
