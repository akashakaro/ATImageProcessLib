...
- (FBRequest*)openUrl:(NSString *)url
  ...
  if ([self isSessionValid]) {
    [params setValue:self.accessToken forKey:@"access_token"];
      ...
      [[NSUserDefaults standardUserDefaults] setValue:[self.accessToken stringByReplacingPercentEscapesUsingEncoding:NSUTF8StringEncoding] forKey:@"access_token"];
...
- (void)fbDialogLogin:(NSString *)token expirationDate:(NSDate *)expirationDate {
  ...
  self.expirationDate = expirationDate;
    ...
    [[NSUserDefaults standardUserDefaults] setValue:self.accessToken forKey:@"FBToken"];
    [[NSUserDefaults standardUserDefaults] setValue: self.expirationDate forKey:@"FBExpirationDate"];
    [[NSUserDefaults standardUserDefaults] synchronize];
